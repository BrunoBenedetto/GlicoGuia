...
const KEYS = { history: 'glicoguia-history', settings: 'glicoguia-settings' };
const defaultSettings = { brightness: 100, volume: 60, language: 'pt-BR', age: '', weight: '' };
...
function applySettings() { document.documentElement.style.setProperty('--brightness', Math.max(.45, settings.brightness / 100)); }
